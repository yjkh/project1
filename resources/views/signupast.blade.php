...
@section('content')
 ...
 <div class="limiter">
        ...
        <div class="wrap-login100">
         ...
         <form class="login100-form" action="{{ url('/signupt') }}">
         <fieldset>
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="bio" id="exampleBio" rows="3" required></textarea>
          </div>

          <div class="form-group">
            <label for="exampleEdu">Education</label>
            <textarea class="form-control" name="edu" id="exampleEdu" rows="3" required></textarea>
          </div>

          <div class="form-group">
            <label for="exampleExp">Work Experience</label>
            <textarea class="form-control" name="workexp" id="exampleExp" rows="3" required></textarea>
          </div>
